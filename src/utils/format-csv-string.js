const formatStringToCsv = (stringArg) => {
    ...
    const promise = new Promise((resolve, reject) => {
        let dataRows = [];
        // Check if the string input has more than one line, indicated by \n. In a case where there isn't, it likely isn't quite a 'true' CSV. Return a warning notice to the user.
        if (stringArg.match(/\\n/) === null) {
            ...
            // Make sure the header row and all subsequent rows have same number of indexes/fields. Otherwise, return a warning notice to the user.
